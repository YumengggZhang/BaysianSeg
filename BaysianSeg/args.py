...
def add_experiment_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument("--dataset_dir", default=r"/home/molloi-lab-linux2/Desktop/BayeSeg/dataset/heartchamber", type=str)
    parser.add_argument("--in_channels", default=1, type=int)

    # loss weight
    parser.add_argument("--ce_loss_coef", default=1, type=float)
    parser.add_argument("--dice_loss_coef", default=0, type=float)
    parser.add_argument("--bayes_loss_coef", default=1000, type=float)
...
def add_management_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument("--resume", default=r"C:\Users\SongL\Desktop\BayeSeg\logs\checkpoints\best_checkpoint.pth", help="resume from checkpoint")
