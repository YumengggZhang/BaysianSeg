...
class EfficientNet(nn.Module):
    ...
    def __init__(self, block_args_list, global_params):
        ...
        self._conv_stem = Conv3dSamePadding(in_channels,
                                            out_channels,
                                            kernel_size=3,
                                            stride=2,
                                            bias=False,
        ...
        self._bn0 = InstanceNorm3d(
                        num_features=out_channels,
                        eps=batch_norm_epsilon,
                        momentum=batch_norm_momentum,
                        affine=True,                # Often True for learnable scale/shift
                        track_running_stats=False,  # Typically False for instance norm
                        name='head_instance_norm')
        ...
        self._conv_head = Conv3dSamePadding(in_channels,
                                            out_channels,
                                            kernel_size=1,
                                            bias=False,
                                            name='head_conv')
        self._bn1 = InstanceNorm3d(
                        num_features=out_channels,
                        eps=batch_norm_epsilon,
                        momentum=batch_norm_momentum,
                        affine=True,                # Often True for learnable scale/shift
            ...
            class CustomHead(nn.Module):
                ...
                def n_channels(self):
                    n_channels_dict = {'efficientnet-b0': 1280, 'efficientnet-b1': 1280, 'efficientnet-b2': 1408,
                                       'efficientnet-b3': 1536, 'efficientnet-b4': 1792, 'efficientnet- ': 2048,
