...
from .layers import *
from .efficientnet_norm import EfficientNet
...
class EfficientUnet(nn.Module):
    def __init__(self, encoder, out_channels=2, concat_input=True):
        ...
        self.up_conv1 = up_conv_3d(self.n_channels, 512)
        self.double_conv1 = double_conv_3d(self.size[0], 512)
        self.up_conv2 = up_conv_3d(512, 256)
        self.double_conv2 = double_conv_3d(self.size[1], 256)
        self.up_conv3 = up_conv_3d(256, 128)
        self.double_conv3 = double_conv_3d(self.size[2], 128)
        self.up_conv4 = up_conv_3d(128, 64)
        self.double_conv4 = double_conv_3d(self.size[3], 64)

        if self.concat_input:
            self.up_conv_input = up_conv_3d(64, 32)
            self.double_conv_input = double_conv_3d(self.size[4], 32)
