...
def add_experiment_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument("--checkpoint_dir", default='/home/molloi-lab-linux2/Desktop/BayeSeg/logs/model/unet_baye_2', type=str)
    parser.add_argument("--dataset", default="ImageCAS", type=str)

    # Model parameters
    parser.add_argument("--model", default="BayeSeg3d", required=False)
    parser.add_argument("--dataset_dir", default=r"./dataset/imageCAS3d/crop", type=str)
...
def add_management_args(parser: ArgumentParser) -> None:
    ...
    parser.add_argument("--resume", default=r".\logs\checkpoints\best_checkpoint.pth", help="resume from checkpoint")
